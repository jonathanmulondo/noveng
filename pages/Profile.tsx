...
import { Award, Zap, Book, Settings } from 'lucide-react';
    ...
    <div className="p-6 md:p-10 max-w-4xl mx-auto">
      <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 mb-8 flex flex-col md:flex-row items-center gap-8">
        <div className="relative">
            <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-blue-500 to-cyan-400 flex items-center justify-center text-white text-3xl font-bold">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        {MOCK_USER.badges.map((badge, i) => (
            <div key={i} className="bg-gradient-to-br from-amber-100 to-orange-50 p-6 rounded-xl border border-orange-100 flex flex-col items-center text-center">
                ...
                <p className="text-xs text-orange-700/70 mt-1">Unlocked 2023</p>
            </div>
        ))}
