...
// Video caption mappings (generated by OpenAI Whisper)
const VIDEO_CAPTIONS: Record<string, string> = {
  '1765193071144-VID-20251208-WA0011.mp4': 'https://mtvwxjuofppthkrwuxnu.supabase.co/storage/v1/object/public/captions/1765193071144-VID-20251208-WA0011.vtt',
  '1765193057935-VID-20251208-WA0010.mp4': 'https://mtvwxjuofppthkrwuxnu.supabase.co/storage/v1/object/public/captions/1765193057935-VID-20251208-WA0010.vtt',
  '1765193039913-VID-20251208-WA0009.mp4': 'https://mtvwxjuofppthkrwuxnu.supabase.co/storage/v1/object/public/captions/1765193039913-VID-20251208-WA0009.vtt',
  '1765193027936-VID-20251208-WA0008.mp4': 'https://mtvwxjuofppthkrwuxnu.supabase.co/storage/v1/object/public/captions/1765193027936-VID-20251208-WA0008.vtt',
  '1765193016490-VID-20251208-WA0007.mp4': 'https://mtvwxjuofppthkrwuxnu.supabase.co/storage/v1/object/public/captions/1765193016490-VID-20251208-WA0007.vtt',
};
...
const FeedPost: React.FC<{ post: FeedItem; isActive: boolean }> = ({ post, isActive }) => {
  ...
  // Get caption URL for this video
  const getCaptionUrl = (videoSrc: string) => {
    const fileName = videoSrc.split('/').pop();
    return fileName ? VIDEO_CAPTIONS[fileName] : undefined;
  };
    ...
    <div className="w-full h-full relative flex items-center justify-center bg-gradient-to-br from-neutral-950 via-purple-950/20 to-neutral-950 snap-start shrink-0 select-none">
      ...
      >
         {post.type === 'video' ? (
           ...
           >
             {getCaptionUrl(post.src) && (
               <track
                 kind="captions"
                 src={getCaptionUrl(post.src)}
                 srcLang="en"
                 label="English"
                 default
               />
